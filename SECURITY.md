...
| Handoff- und Ergebnissignatur sind **HMAC** (symmetrisch); Audit-Köpfe sind nach v0.1 Ed25519 | Wer eine Ergebnis- oder Handoff-Signatur prüfen kann, kann sie auch erzeugen; Unabhängigkeit dort ist organisatorisch, nicht kryptografisch. Für Audit-Köpfe gilt das nicht mehr: Prüfer und Anker halten nur den öffentlichen Schlüssel | `tests/test_verifier.py::test_the_symmetric_key_means_this_instance_could_also_sign` (offen gehalten) |
