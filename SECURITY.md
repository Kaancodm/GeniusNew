...
| Worker-Isolation ist eine **Prozessgrenze**, keine microVM | Kein Schutz gegen bereits geladenen nativen Code oder rohe Syscalls; ohne POSIX-Limits (Windows) keine Ausführung — dort nur über WSL | `docs/ISOLATION-V01.md`, `tests/test_isolation.py`, Windows-Job in `.github/workflows/verify.yml` |
